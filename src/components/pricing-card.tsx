        ...
        <CardContent className="relative">
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              Instantly improve prompt clarity, tone, and effectiveness with
              smart suggestions
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
              Get in-line enhancements as you type, without disrupting your
              workflow.
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
              Rephrase or expand your ideas with one click to get better AI
              results.
            </li>
            <li className="flex items-start gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
              Tailored improvements based on the platform you're using (ChatGPT,
              Gemini, Claude, etc.).
            </li>
          </ul>
        </CardContent>
